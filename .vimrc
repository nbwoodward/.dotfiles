...
command! O :mark z | :tabedit % | :'z "Expand current pane to a new window
command! C :mark z | :tabclose | :'z | normal zz "Close current expanded window
...
nnoremap :M :!tmux send -t 1 'make' Enter <CR><C-L>
...
autocmd FileType javascript :ALEDisable
